...
3. Доступны следующие функции:
   ...
   - Также в любой момент можно инициировать базу данных через ручку */setup_database*. После инициации в директуре создается база данных predictions.db, в которой сохраняется имя загруженного файла, время загрузки и ссылка на скачивание предсказаний в формате csv.
